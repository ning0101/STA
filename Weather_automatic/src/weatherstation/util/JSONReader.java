...
public class JSONReader {
	...
	public JSONReader() {
		try {               
            ...
            //創建JSON對象
            JsonObject object = (JsonObject) parser.parse(new FileReader("data/O-A0001-001.json"));
            //讀取鍵值對
