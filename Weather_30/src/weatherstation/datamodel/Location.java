...
public class Location {
	public static HashMap<String, Integer> locations = new HashMap<String, Integer>();
    ...
    public Location(String name, String description, String encodingType, String type) {
    	this.name = name;
