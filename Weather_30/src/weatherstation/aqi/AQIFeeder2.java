...
//        ArrayList<WeatherData> weatherData = jsonReader.getStation();;
...
//            Cache.STACache cache = Cache.cacheMap.get("氣象站(年)-"+sitId);
//            if(cache!=null){
...
//                createObservationByDatastream(metro_data, cache, "HPA");
//                createObservationByDatastream(metro_data, cache, "RAIN");
//                System.out.println("");
//             }
//             else{
//                System.out.println("");
